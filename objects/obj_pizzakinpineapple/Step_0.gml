...
if ((global.pineapplefollow == 1 && sprite_index != spr_toppinpineapple_intro) && !taunt)
{
    ...
    {
        ds_queue_enqueue(followQueue, obj_pizzakinsausage.x - thing);
        ds_queue_enqueue(followQueue, obj_pizzakinsausage.y);
    }
    else if (global.tomatofollow == 1)
    {
        ds_queue_enqueue(followQueue, obj_pizzakintomato.x - thing);
...
if ((((global.playerhealth == 1 && global.pineapplefollow == 1) || global.panic || global.deathmode || global.snickchallenge) && sprite_index == spr_toppinpineapple) && !taunt)
