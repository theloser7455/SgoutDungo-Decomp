...
draw_set_alpha(1);
var font = font_add_sprite_ext(global.fontspritee, global.fontcharacterss, true, 0);
draw_set_font(font);
...
if (selected == 3)
    draw_text_colour(480, 250, "BREAKDANCE MUS: " + string(global.audiomusbreakdancevol), c_white, c_white, c_white, c_white, 1);
else
    draw_text_colour(480, 250, "BREAKDANCE MUS: " + string(global.audiomusbreakdancevol), c_white, c_white, c_white, c_white, 0.5);
