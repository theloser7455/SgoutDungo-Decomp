...
switch (state)
{
    ...
    case states.secondjump:
        ...
        {
            stunned = 100 * (instance_number(obj_pepperman_weak) + 1);
    ...
    case states.handstandjump:
        ...
        if (grounded)
        {
            scr_soundeffect(sfx_groundpound);
            state = states.stunned;
            stunned = 200 * (instance_number(obj_pepperman_weak) + 1);
            stunned += (25 * phase);
...
if (state == states.secondjump && !audio_is_playing(sfx_greatermanrun))
    scr_soundeffect(sfx_greatermanrun);

if (state != states.secondjump && audio_is_playing(sfx_greatermanrun))
    audio_stop_sound(sfx_greatermanrun);
